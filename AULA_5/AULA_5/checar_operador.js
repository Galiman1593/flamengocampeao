...
if (operadorEscolido === "+") {
  ...
  console.log(
    "operador de resto, faz a divisao mas exibe o resto ao em vez do resultado"
  );
}
//coparação
else if (operadorEscolido === "==") {
  ...
  console.log(
    "Operador de MENOR ou IGUAL, verifica se o valor e MENOR ou IGUAL"
  );
} else if (operadorEscolido === ">=") {
  console.log(
    "Operador de MAIOR ou IGUAL, verifica se o valor e MAIOR ou IGUAL"
  );
}
//logico
else if (operadorEscolido === "&&") {
  ...
  console.log(
    "Operador de OU, pelo menos uma das condições devem ser veradeiras"
  );
} else if (operadorEscolido === "!") {
